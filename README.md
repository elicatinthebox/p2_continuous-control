...
For this project, I use the second version of the Unity environment provided by Udacity that contains 20 identical agents, each with its own copy of the environment.  
